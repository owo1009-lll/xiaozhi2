...
function buildTeacherAlignmentEvidenceFromPassJson(passJson = {}) {
  ...
  if (isPartialCoverage) {
    // partial coverage: judge the aligned-span ratio (both bounds)
    ...
    // full coverage (or legacy whole-piece): judge estimatedPieceDuration / audio
...
function readTeacherAlignmentEvidence(item = {}, analysis = {}, repoRoot) {
  ...
  if (embedded && typeof embedded === "object") {
    return {
      ...
      alignedSpanRatio: safeNumber(embedded.alignedSpanRatio, null),
      coverageMode: safeString(embedded.coverageMode) || null,
