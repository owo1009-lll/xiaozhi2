...
>
> **前两批受控 pilot 已完成(2026-07-10):** 产品负责人批准与 preflight 均有效。首批 `stu01-ex01-correct`:60 候选 / 8 auto-pass / 3 known usable / 0 known wrong / 0 unknown。第二条 `stu02-ex02-wrong_pitch` 在机器预检因 0 个严格自检候选被淘汰,未进入正式 session。第二批改用独立录音 `stu03-ex03-missing_note`:60 候选 / 11 auto-pass / 2 known usable / 0 known wrong / 0 unknown。累计 2 个 `completed_safe` session、2 条独立录音、120 候选、19 auto-pass、5 known usable、0 known wrong、0 unknown。命令退出后环境均已恢复,未发布学生反馈,默认 runtime 继续 fail-closed。
