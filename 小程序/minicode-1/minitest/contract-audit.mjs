...
assert.match(reviewScore, /submissionId:\s*this\.submissionId/, "score diagnosis must bind to the released submission");
assert.match(reviewScore, /issue\.pageNumber/, "multipage issues must retain their page number");
assert.match(reviewScore, /scorePages/, "score overlays must be grouped per rendered page");
