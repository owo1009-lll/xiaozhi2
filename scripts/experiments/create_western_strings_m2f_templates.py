    ...
    readme.write_text(
        "\n".join(
            [
                ...
                "2. Replace every placeholder path with a real local audio/score path.",
                "3. Keep `consent=yes`, `humanChecked=yes`, and a valid `licenseStatus` only",
                "   when the recording is actually cleared for local research use.",
                "4. Run the studentSafe gate, then fill `real-student-recording-results.csv`.",
                "5. Run `npm run test:western-m2f-real-recordings`.",
                "",
