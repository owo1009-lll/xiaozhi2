    ...
    readme.write_text(
        "\n".join(
            [
                ...
                "5. Run the studentSafe preview and human/gold review, then fill",
                "   `real-student-recording-results.csv` counts.",
                "6. Use `npm run western:m2f-status` for inspection.",
                "7. Use `npm run western:m2f-gate` as the release-blocking command.",
                "",
