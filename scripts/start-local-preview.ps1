...
$serverLog = Join-Path $dataDir "preview-server.log"
$serverErrLog = Join-Path $dataDir "preview-server-error.log"
$analyzerLog = Join-Path $dataDir "preview-analyzer.log"
$analyzerErrLog = Join-Path $dataDir "preview-analyzer-error.log"
...
Write-Host ""
Write-Host "Local project preview"
Write-Host "---------------------"
